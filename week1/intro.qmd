...
<center>![](figures/rstudio.png){width="80%"}</center>
...
<center>![](figures/rstudio-appearance.png){width="60%"}</center>
...
<center>![](figures/dplyr-pkgdown-1.png){width="80%"}</center>
...
![](figures/summarize-pkgdown.png){width="80%"}
:::

::: column
From `?dplyr::summarise`:

![](figures/summarize-help.png){width="80%"}
:::
:::::
...
<center>![](figures/pkgdown-get-started.png){width="60%"}</center>
...
<center>![](figures/emoji-github.png){width="60%"}</center>

## [Example: search and install from GitHub]{.r-fit-text}

<center>![](figures/emoji-github-2.png){width="70%"}</center>
